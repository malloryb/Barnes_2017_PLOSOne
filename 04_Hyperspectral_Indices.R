#04_Hyperspectral_Indices
#Purpose: Calculate hyperspectral indices
...
#Function to batch calculate all indices 
...
setwd(dir = "C:/Users/rsstudent/Dropbox (Personal)/Mallory_Hyperspectral/9_2_2016_hyperspectral/")
textfiles = list.files("ASCII_Reflectance/", pattern = "*.txt")


#Changing workign dir to run function
setwd(dir = "C:/Users/rsstudent/Dropbox (Personal)/Mallory_Hyperspectral/9_2_2016_hyperspectral/ASCII_Reflectance/")
...
#Where x is a dataframe -> for "MODIS-like" NDVI
FWHM = function(x){
